...
intelevator: main.o event.o client.o elevator.o eventtype.o floor.o config.o building.o direction.o timer.o trip.o statistics.o eventqueue.o
	$(CPP) $^ -o $@
