...
void Simulator::run() {
  ...
  auto ca1 = std::make_shared<ClientArrival>(10, std::make_shared<const Client>(1, 0, 5));
  auto ca2 = std::make_shared<ClientArrival>(20, std::make_shared<const Client>(1, 3, 1));
